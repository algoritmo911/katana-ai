...
from datetime import datetime, timezone # Import datetime and timezone for ISO validation
...
class TestCommandTelemetry(unittest.TestCase):
    ...
    def test_01_log_file_creation(self):
        ...
        with mock.patch('katana.decorators.trace_command.getpass.getuser', return_value="test_user"):
    ...
    def test_02_successful_command_logging(self):
        ...
        self.assertTrue(is_iso_timestamp(log_entry["command_start_time_utc"])) # Check start time
        self.assertTrue(is_iso_timestamp(log_entry["log_event_timestamp_utc"])) # Check log event time
    ...
    def test_03_failing_command_logging(self):
        with self.assertRaises(ValueError) as context, \
             mock.patch('katana.decorators.trace_command.getpass.getuser', return_value="test_user"):
