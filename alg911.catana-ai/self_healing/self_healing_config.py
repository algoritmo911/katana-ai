...
MAX_CONSECUTIVE_RECOVERY_ATTEMPTS = 3 # Max recovery attempts for a single issue before escalating/logging critical
        ...
        "recovery_plugins": [
            {
                ...
                "config": {"service_name": "katana_api_service_name_in_systemd_or_script"} # Placeholder
            }
        ]
    },
    "katana_main_process": {
        ...
        "diagnostic_plugins": [
            {
                "plugin": "ProcessNotRunningDiagnoser", # To be implemented
                "config": {}
            }
        ],
        "recovery_plugins": [
        ...
        "diagnostic_plugins": [
            {
                ...
                "config": {"critical_pattern_threshold": 1} # Trigger if 1 or more critical patterns found
            }
        ],
        "recovery_plugins": [
